...
\begin{document}
    ...
    \begin{Exercise}[number={71}]
      \begin{enumerate}[a)]
        ...
        \item \begin{itemize}
                ...
                \item $P(D)=p_3=\frac{1}{8}$ \hspace{3cm} \quad ou \qquad $P(D)=\frac{2}{16}$
    ...
    \begin{Exercise}[number={88}]
      \begin{enumerate}[a)]
        ...
        \item \begin{minted}[autogobble]{vbscript}
                n=1  `En VBA
      ...
      \begin{enumerate}[a)]
        \item On déduit $p_2=\frac{1}{4}$, parce que $\displaystyle\sum^r_{i=1}\left(p_i\right)=1$
              ...
              \begin{flalign*}
                ...
                \iff&\quad \frac{15}{20}\times -1+\frac{5}{20}x=0 &\\
                \iff&\quad x=3 
              \end{flalign*}
              ...
              \end{tabular}\hfill\mbox{}\medbreak
              \parbox{\linewidth}{\captionof{figure}{Tableau présentant la loi de probabilité de C}}
              On déduit $p_2=\frac{1}{9}$, parce que $\displaystyle\sum^r_{i=1}\left(p_i\right)=1$
              \vspace{-\baselineskip}
              \begin{flalign*}
                &\quad E(M)=0 &\\
                \iff&\quad p_1x_1+p_2x_2=0 &\\
                \iff&\quad\frac{-8}{9}+\frac{z}{9}=0 &\\
                \iff&\quad z=8
              \end{flalign*}
              \hfill\begin{tabular}[t]{ | l || >{\centering}m{0.05\textwidth}| >{\centering\arraybackslash}m{0.05\textwidth}| } \firsthline
                $m_i$ & $-1$ & $8$ \\ \hline
              ...
              \end{tabular}\hfill\mbox{}\medbreak
              \parbox{\linewidth}{\captionof{figure}{Tableau présentant la loi de probabilité de M}} \pagebreak
