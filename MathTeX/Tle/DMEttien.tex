...
\begin{document}
    ...
    \begin{enumerate}[label=\protect\circled{\arabic*}]
        \item   \begin{enumerate}[label=\alph*.]
                ...
                \item   $z_{M'}=\frac{10}{x-10i}=\frac{10(x+10i)}{(x-10i)(x+10i)}=\frac{10x}{x^2+100}+\frac{100i}{x^2+100}$

                        $z_{M'}-\frac{1}{2}i=\frac{10x}{x^2+100}+\frac{200i-x^2i-100i}{2(x^2+100)}=\frac{10x}{x^2+100}+\frac{(100-x^2)i}{2(x^2+100)}$
                        \vspace{0.25cm}

                        Posons $z_A=\frac{1}{2}i$.

                        $\begin{aligned}[t]
                            \abs{AM'}&=\abs{\frac{10x}{x^2+100}+\frac{(100-x^2)i}{2(x^2+100)}}=\sqrt{\left(\frac{10x}{x^2+100}\right)^2+\left(\frac{(100-x^2)}{2(x^2+100)}\right)^2} &\\
        ...
        \item   \begin{enumerate}[label=\alph*.]
                    \item $\begin{aligned}[t]
                                ...
                                &=\abs{\frac{20z_{M}}{2\abs{z_{M}}^2}-\frac{1}{2}i}^2=\abs{\frac{20Re(z_{M})}{2\abs{z_{M}}^2}+\frac{20Im(z_{M})-\abs{z_{M}}^2i}{2\abs{z_{M}}^2}}^2 \\
                    ...
                    \item   $\begin{aligned}[t]
                                ...
                                &\iff \abs{\frac{20Re(z_{N})}{2\abs{z_N}^2}+\frac{20Im(z_{N})-\abs{z_N}^2i}{2\abs{z_N}^2}}^2=\frac{1}{4} \\
