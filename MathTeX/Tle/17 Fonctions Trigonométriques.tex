        ...
        \begin{Spartie}{Rappel} 
            ...
            \begin{center}
                \begin{tikzpicture}[scale=2]
                    ...
                    \draw[-stealth, red, thick] (0,0) -- (0.54,0.84) node[dot,label={[label distance=-2pt]above right:$M$}] {};

                    \draw[angle radius=11mm, angle eccentricity=1.2] (0.11,0.17) -- (0.2,0) arc (0:45,1cm);
                \end{tikzpicture}
