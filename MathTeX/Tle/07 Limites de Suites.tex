    ...
    \begin{Gpartie}{Opérations sur les Limites} 
        ...
        \begin{Spartie}{Somme}
            ...
            \resizebox{0.75\linewidth}{!}{
                ...
                \multirow{2}{*}{$\lim v_n$}  & \multicolumn{3}{c}{$\lim u_n$}        \\
                \cmidrule(r l){2-4}
                            & $\ell'$       & $+\infty$ & $-\infty$ \\ \midrule
            ...
            \end{center}
            \parbox{\linewidth}{\captionof{figure}{Tableau des Limites de Sommes de Suites}} \\[2ex]
        ...
        \begin{Spartie}{Produit}
            \begin{center}
                ...
                \begin{tabular}{ p{0.15\linewidth} *{4}{M{0.17\linewidth} }} \toprule
                    \multirow{2}{*}{$\lim v_n$} & \multicolumn{4}{c}{$\lim u_n$} \\
                    \cmidrule(r l){2-5}
            ...
            \end{center}
            \parbox{\linewidth}{\captionof{figure}{Tableau des Limites de Produits de Suites}}
            \begin{SSpartie}{Exemple} 
        ...
        \begin{Spartie}{Quotient}
            ...
            \end{center}
            \parbox{\linewidth}{\captionof{figure}{Tableau des Limites de Quotients de Suites}} 
            \\[2ex]
            \begin{SSpartie}{Exemple} 
                ...
                \begin{center}
                    \begin{tikzpicture}[scale=0.9]
                        \begin{axis}[
                            ...
                            \draw 
                                (4,4) node [dot, label={[label distance=-2pt]0:$\scriptscriptstyle  f(x)=x$}] {}
                                (0,0) node [dot, label={[label distance=-2pt]315:$\scriptscriptstyle  f(x)=x$}] {}
                                (-1,-1) node [label={[label distance=-2pt]180:$\scriptscriptstyle y=x$}] {}
                                (-1.5,1) node [label={[label distance=-2pt]200:$\scriptscriptstyle y=f(x)$}] {};
