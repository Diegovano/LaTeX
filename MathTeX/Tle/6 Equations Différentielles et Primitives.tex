...
\begin{document}
    ...
    \begin{Gpartie}{Calcul des Primitives} 
        \begin{Spartie}{Primitives des Fonctions usuelles} 
            ...
            \parbox{\linewidth}{\captionof{figure}{Tableau des Primitives des Fonctions Usuelles}}
        \end{Spartie}
        \begin{Spartie}{Primitives de Fonctions Composées}
            ...
            \begin{center}\begin{tabular}[c]{ |c|c|c| } \hline
                ...
                $u'\cos(u)$                                             & $\sin(u)$                                                                 & \---\\ \hline
            \end{tabular}\end{center}
            \parbox{\linewidth}{\captionof{figure}{Tableau des Primitives de Fonctions Composées}}
        \end{Spartie}
        \pagebreak
