...
\cvlistitem{Developed with a group a friends a website which converts assembly code to machine code for our coursework. This website was endorsed by our Professor who recommended the tool to the cohort (120+ students).}

\cvlistitem{Participated in the 2020 Astro Pi competition, organised by the ESA, where we wrote a program that was run on a Raspberry Pi onboard the ISS to gather data in order to perform an experiment. Developed a \httplink[website (\texttt{https://astropi.diegovano.com/})]{https://astropi.diegovano.com/}  to overlay data captured onto a map.}

\cvlistitem{Underwent two A320 Flight Simulator individual training sessions in full motion training simulators courtesy of \httplink[Avenger Flight Group (\texttt{https://www.afgsim.com/})]{https://www.afgsim.com/}
