    ...
    \begin{Exercise}[number={69}]
      \begin{enumerate}[a)]
        ...
        \item \begin{minted}[autogobble]{python}
              ...
              \end{minted}
              Si on imagine l'arbre pondéré de cette situation, on obtient un arbre énorme. 
              \begin{equation*}
              ...
              \end{equation*}
              Finallement, on a $P(X=7)=0{,}62^7\times 0{,}38^3\times 120\approx 0{,}2319$ \\ 
              Ceci est cohérent avec ce que je retrouve dans mes simualtions $(n=10\ 000)$. \\ Cependant, je suis certain qu'il existe  une méthode $\infty$ment plus simple de résoudre le problème. 
      \end{enumerate}
    \end{Exercise}
\end{document}