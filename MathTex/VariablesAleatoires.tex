...
\begin{document}
    ...
    \begin{Exercise}[number={69}]
      \begin{enumerate}[a)]
        ...
        \begin{center}\begin{tabular}{ |l|| *{2}{p{0.3\textwidth}|} } \hline
          $x_i$      & 0                                 & 1                                               \\ \hline
        ...
        \item \begin{minted}[autogobble]{python}
              ...
              Cependant, je pense que c'est faux. Mes simulations indiquent une probabilité plus proche de $0{,}23 \quad (n=10\ 000)$. %test
      \end{enumerate}
    \end{Exercise}
\end{document}